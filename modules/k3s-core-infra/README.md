...
| <a name="input_k3s_setup_etcd_backup"></a> [k3s\_setup\_etcd\_backup](#input\_k3s\_setup\_etcd\_backup) | Create all necessary stuctures to have etcd backup | `bool` | n/a | yes |
